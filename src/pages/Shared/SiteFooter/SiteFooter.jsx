            ...
            <div className="w-full ">
                <div className="grid max-w-screen-xl mx-auto justify-between sm:flex sm:justify-between md:flex md:grid-cols-1">
                    <div className="w-6/12 lg:ml-4">
                        ...
                        <p className="text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugit aliquam necessitatibus cumque voluptatibus harum deleniti voluptate, sapiente mollitia exercitationem, molestias suscipit, ex enim! Fuga accusantium, sint fugit saepe sit ex.</p>
                    </div>
