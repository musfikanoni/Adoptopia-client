...
const DonationCampaignCard = ({donation}) => {
    const {_id, pet_image, pet_name, maximum_donation_amount, donated_amount} = donation;
    return (
        <div className="lg:ml-5">
            <Card
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">Maximum Donation Amount: {maximum_donation_amount}</p>
